 ...
 */
final class Version20240919225419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP affiliate_link');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD affiliate_link LONGTEXT DEFAULT NULL');
